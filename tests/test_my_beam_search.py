...
from  fairseq.beam_search import MySequenceGenerator
...
class TestJitMySequenceGeneratorBase(unittest.TestCase):
    def setUp(self):
...
class TestJitMySequenceGenerator(TestJitMySequenceGeneratorBase):
...
class TestMySequenceGeneratorBase(unittest.TestCase):
...
class TestMySequenceGenerator(TestMySequenceGeneratorBase):
    def setUp(self):
        (
            self.tgt_dict,
            self.w1,
    ...
    def test_with_normalization(self):
        generator = MySequenceGenerator([self.model], self.tgt_dict, beam_size=2)
    ...
    def test_generation_with_additional_input(self):
        ...
        generator = MySequenceGenerator([add_input_model], self.tgt_dict, beam_size=2)
...
class TestTopPSamplingSearch(TestMySequenceGeneratorBase):
    def setUp(self):
